                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('book.update',$book->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input name="title" value="{{ $book->title }}" class="form-control"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input name="description" value="{{ $book->description }}" class="form-control"
                            ...
                            <div class="form-group row">
                                <label for="example-text-input"
                                    class="col-md-2 col-form-label form-control-label">Cover</label>
                                <div class="col-md-10">
                                    @if (isset ($book) && $book->cover)
                                    <p>
                                        <br>
                                        <img src="{{ asset('assets/img/cover/' .$book->cover)}}"
                                            style="max-height: 125px; max-width: 125px; margin-top: 7px;" alt="">
                                    </p>
                                    @endif
                                    <input name="cover" value="{{ $book->cover }}" class="form-control" type="file"
                                        placeholder="" id="">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select name="id_category" value="{{ $book->category->name_category }}"
                                        class="form-control">
                                        <option>pilih Category</option>
                                        @foreach($category as $data)
                                        <option value="{{ $data->id }}" {{ $data->id == $book->id_category ? 'selected'
                                            : '' }}>{{ $data->name_category }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                <label for="example-text-input"
                                    class="col-md-2 col-form-label form-control-label">Author</label>
                                <div class="col-md-10">
                                    <select name="id_author" class="form-control"
                                        value="{{ $book->author->name_author }}">
                                        <option>pilih Author</option>
                                        @foreach($author as $data)
                                        <option value="{{ $data->id }}" {{ $data->id == $book->id_author ? 'selected' :
                                            '' }}>{{ $data->name_author }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                <label for="example-text-input"
                                    class="col-md-2 col-form-label form-control-label">Publisher</label>
                                <div class="col-md-10">
                                    <select name="id_publisher" class="form-control"
                                        value="{{ $book->publisher->name_publisher }}">
                                        <option>pilih Publisher</option>
                                        @foreach($publisher as $data)
                                        <option value="{{ $data->id }}" {{ $data->id == $book->id_publisher ? 'selected'
                                            : '' }}>{{ $data->name_publisher }}</option>
                                        @endforeach
                                    </select>
