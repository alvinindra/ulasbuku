...
<li class="breadcrumb-item"><a href="{{ route('admin.page.index', 'editPublisher') }}">{{ __('Kelola Publisher') }}</a>
</li>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('publisher.update',$publisher->id) }}">
                            ...
                            <div class="form-group row">
                                <label for="example-text-input" class="col-md-2 col-form-label form-control-label">Name
                                    Publisher</label>
                                <div class="col-md-10">
                                    <input name="name_publisher" class="form-control" type="text"
