...
@section('content') 
    @component('admin.layouts.headers.auth') 
        @component('admin.layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.page.index', 'formAuthor') }}">{{ __('Kelola Author') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Form Author') }}</li>
        @endcomponent 
    @endcomponent
