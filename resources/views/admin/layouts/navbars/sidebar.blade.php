            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    {{-- <li class="nav-item {{ $parentSection == 'dashboards' ? 'active' : '' }}">
                        <a class="nav-link collapsed" href="{{ url('admin/book') }}" data-toggle="" role="button" aria-expanded="{{ $parentSection == 'dashboards' ? 'true' : '' }}" aria-controls="navbar-dashboards">
                        ...
                        <div class="collapse {{ $parentSection == 'dashboards' ? 'show' : '' }}" id="navbar-dashboards">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item {{ $elementName == 'tabelDashboard' ? 'active' : '' }}">
                                    <a href="{{ url('admin/book') }}" class="nav-link">{{ __('Dashboard') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li> --}}
